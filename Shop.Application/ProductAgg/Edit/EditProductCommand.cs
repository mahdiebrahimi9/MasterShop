...
namespace Shop.Application.ProductAgg.Edit
{
    ...
    {
        public EditProductCommand(string productName, string productCode, Price productPrice, Discount productDiscount, int count, int totalRate, string title, string description, string color, string category, bool bestSelling, int design, int purchaseValue, int buildQuality, int featured, long productId)
        {
